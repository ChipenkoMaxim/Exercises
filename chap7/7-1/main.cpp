...
class Student {
    private:
        typedef bool(Student::*firstStudentPolicy)(StudentData r1, StudentData r2);
    private:
    ...
    public:
        ...
        void toString();
        void setFirstStudentPolicy(policyFunc choice);
    ...
    private:
        ...
        void setFirstStudentPolicyPrivate(firstStudentPolicy f);
};


bool Student::higherGrade(StudentData r1, StudentData r2) {
    return r1.grade() > r2.grade();
}

bool Student::lowerStudentNumber(StudentData r1, StudentData r2) {
    return r1.id() < r2.id();
}

bool Student::nameComesFirst(StudentData r1, StudentData r2) {
    return strcmp(r1.name().c_str(), r2.name().c_str()) < 0;
}

bool higherGrade1(StudentData r1, StudentData r2) {
    return r1.grade() > r2.grade();
}
...
int main() {
    ...
    stud.toString();
    StudentData newData;
    stud.setFirstStudentPolicy(policyFunc::NAME_COMES_FIRST);
...
void Student::setFirstStudentPolicy(policyFunc choice) {
    switch (choice)
    {
    case policyFunc::HIGHER_GRADE:
         setFirstStudentPolicyPrivate(&Student::higherGrade);
        break;
    case policyFunc::LOWER_STUDENT_NUMBER:
        setFirstStudentPolicyPrivate(&Student::lowerStudentNumber);
        break;
    case policyFunc::NAME_COMES_FIRST:
        setFirstStudentPolicyPrivate(&Student::nameComesFirst);
        break;
    default:
        break;
    }
...
void Student::setFirstStudentPolicyPrivate(firstStudentPolicy f) {
    _currentPolicy = f;
}
...
StudentData Student::firstStudent() {
    ...
    while (iter)
    {
        if((this->*_currentPolicy)(iter->data, firstStudent)) {
